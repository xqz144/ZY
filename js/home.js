...
(function() {
    ...
    const EXT_APPS = {
        ...
        'ledger-new':     { key: 'ledger',      page: 'pages/ledger.html' },
        'plan-new':       { key: 'plan',        page: 'pages/plan.html' }
    };
    ...
    window.openApp = function(app) {
        const appActions = {
            ...
            'ledger-new':      () => window.showExtApp('ledger-new'),
            'plan-new':        () => window.showExtApp('plan-new')
        };
